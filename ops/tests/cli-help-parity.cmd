...
# broke nothing. The assertion was always "all N are documented"; this measures that directly, and
# still reds the moment any one of them disappears from help.
bash kit/ops/polaris help | grep -oE '^  (find|show|check|board-fm|claim|verify|handoff|qa|finish|next) ' \
