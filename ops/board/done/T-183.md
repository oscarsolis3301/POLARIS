...
verify:
  ...
  - grep -m1 '^## ' CHANGELOG.md | grep -q '^## 6\.7\.0 — 2026-09-24'
  - grep -q '6\.6\.0' CHANGELOG.md
  - grep -q '^## 6\.5\.0 — 2026-09-15' CHANGELOG.md
map_delta:
surface:
landed: 8dff9fefaee3f3be6e9136e97882e7ef7645f1b8
---
## Why
...
- amend: verify[2] "test "$(grep -m1 '^## ' CHANGELOG.md | cut -c1-9)" = '## 6.7.0'" → "grep -m1 '^## ' CHANGELOG.md | grep -q '^## 6\.7\.0 — 2026-09-24'" — conductor: cut -c1-9 keeps the space after '## 6.7.0', so a dated heading can never pass; check the heading line instead
