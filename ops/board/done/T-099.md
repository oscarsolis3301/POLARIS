...
landed: 2efabcca59eefcbfe8019fd1a94f74bd76eb2cf2
---
## Why
...
- done's closing line now branches too: a LEFT worktree reports `lock cleaned · live worktree + branch feat/<ID> left for sweep --fix` — under landing: self that is the commonest path, and "branch cleaned" would have been a lie on it.
