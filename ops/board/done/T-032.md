...
landed: e09e4e6cc49970a01423e25c031e0cef74b56133
---
## Why
...
- Last landed:/Next up: drop INDEPENDENTLY — real board (ready/ empty) shows only Last landed:, no stall.
- Summary reuses cmd_metrics' awk numbers in-place (p50h falls back to 0 when no claim→done pair).
