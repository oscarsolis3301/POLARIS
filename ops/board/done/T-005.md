...
map_delta:
landed: 1b171bc7fd87f77c730ab24f77b8a584995e9aa5
---
## Why this exists
...
- overlap gate reuses pat_overlap (drift's primitive on owned_match), so refusal is bidirectional: a granted dir/ swallowing another task's exact path refuses too
- grant_append_owned preserves the files_owned list shape (block · [a, b] · [] · inline scalar→flow); rc 1 + untouched file on a missing/malformed key
