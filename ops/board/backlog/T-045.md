...
verify:
  ...
  - t=$(cat kit/ops/polaris kit/ops/lib/*.sh kit/ops/lib/selftest/*.sh | wc -l); test "$t" -ge 3750 && test "$t" -le 3985
...
total inside [3750, 3985] (baseline 3,826 ±2% + the sanctioned loader/header/sharding
allowance): relocation, not rewrite, proven by wc. selftest-install reruns because uninstall and
...
- [ ] wc gates green: entry <500 · modules ≤1200 · total in [3750, 3985]
